...
<div class="container-fluid">
    @foreach($goods->toArray()['goods_img'] as $img)
        
        <div class="col-xs-3" url="{{$img['url']}}" id="{{$img['id']}}"><img src="/storage/{{$img['url']}}" alt="..." class="img-thumbnail"><center><span onclick="del(this ,{{$img['id']}})" class="glyphicon glyphicon-trash"></span></center></div>
