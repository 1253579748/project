		...
		<section class="user-center inner clearfix">
			<div class="pull-left bgf">
				...
				<dl class="user-center__nav">
					<dt>帐户信息</dt>
					<a href="/home/personal/show"><dd>个人资料</dd></a>
					<a href="/home/personal/show"><dd>资金管理</dd></a>
					<a href="/home/personal/show"><dd>积分平台</dd></a>
					<a href="/home/personal/address"><dd>收货地址</dd></a>
					<a href="/home/personal/show"><dd>我的优惠券</dd></a>
					<a href="/home/personal/paypwd?id={{session('homeuserInfo.id')}}"><dd>修改支付密码</dd></a>
					<a href="/home/personal/logpwd?id={{session('homeuserInfo.id')}}"><dd>修改登录密码</dd></a>
				</dl>
				<dl class="user-center__nav">
					<dt>订单中心</dt>
					<a href="/home/personal/order"><dd class="active">我的订单</dd></a>
					<a href=""><dd>我的收藏</dd></a>
