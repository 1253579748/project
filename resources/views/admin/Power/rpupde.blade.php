...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="color:#666;">修改角色权限</h3>
    </div>
    <div class="panel-body">
        <form class="form-horizontal" role="form" action="rpup" method="post" onsubmit="return false">
...
$('#edt').click(function(){
    ...
    $.ajax({
        type: 'post',
        url: '/admin/power/rpup',
        processData: false,
        contentType: false,
        data: fd,
        success: function(res){
            if (res.code == 0){
                location.href = '/admin/power/rolpow';
            }
        },
        error: function(err){
            alert('修改失败,请重试');
