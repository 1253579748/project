...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="color:#666;">管理员信息</h3>
    </div>
      ...
      <table class="table table-hover" style="margin-top:2px;">
        ...
        <tbody>
          ...
          <tr class="jiedian">
            ...
            <td>
                <button type="submit" class="btn btn-primary delete" data-id="{{ $admin->id }}">删除</button>
                <a href="/admin/adminList/update?id=<?php echo $admin->id ?>">修改</a>
            </td>
          </tr>
          @endforeach
        </tbody>
...
<script>
    ...
    $('.delete').click(function(){
        ...
        $.ajax({
            type: 'post',
            url: '/admin/adminList/del/' + $(this).data('id'),
            data: {
                _token: '{{ csrf_token() }}'
            },
