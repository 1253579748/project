...
class Login extends Controller
{
    ...
    public function yan()
    {
        include(base_path('duanxin/SendTemplateSMS.php'));
        //生成验证码
    ...
    public function yanre()
    {
        ...
        $phone = $_GET['phone'];
        $res = sendTemplateSMS($phone,array($cod,1),"1");//手机号码，替换内容数组，模板ID
    ...
    public function yanup()
    {
        ...
        $phon = $_GET['phone'];
        $res = sendTemplateSMS($phon,array($co,1),"1");//手机号码，替换内容数组，模板ID
