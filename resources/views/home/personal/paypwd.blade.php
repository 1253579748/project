...
@section('title', '修改支付密码')
@section('main')
<div class="pull-right">
<div class="panel panel-default">
    <div class="panel-body">
        <div class="mt" style="padding: 10px;">
            <ul><li><a href="" style="padding-bottom:0;color:#e4393c;border-bottom:2px solid #e4393c;font-weight:700;cursor: pointer;text-decoration: none;">修改支付密码</a></li>
            </ul>
        </div>
        <form class="form-horizontal" role="form" action="paypass" method="post">
            ...
            <div class="form-group" style="margin-bottom: 30px;">
                ...
                <div class="col-sm-5">
                    <input type="password" class="form-control" name="pay_pwd" placeholder="请输入6位数字密码" maxlength="6">
                </div>
            </div>
            <div class="form-group" style="margin-bottom: 30px;">
                <label for="firstname" class="col-sm-2 control-label">确认密码：</label>
                <div class="col-sm-5">
                    <input type="password" class="form-control" name="pay_pw" placeholder="确认密码" maxlength="6">
                </div>
            </div>
            <div class="form-group" style="margin-bottom: 30px;">
